...
def writeTsv(series,Tsv_file):
    s = open(Tsv_file,'w')
    s.write('#SpecFile\tSpecID\tScanNum\tFragMet pev.20170414_121951_515.loghod\tPrecursor\tIsotopeError\tPrecursorError(ppm)\tCharge\tPeptide\tProtein\tDeNovoScore\tMSGFScore\tSpecEValue\tEValue\tQValue\tPepQValue\n')
...
def get_mzid_tsv_convert(Mzid_file,Tsv_file):
    stack_series = []
